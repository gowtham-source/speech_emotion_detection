...
def main():
    ...
    with st.sidebar:
        ...
        st.title('Speech Emotion recogonizer')
        st.markdown(
            '<div style="text-align: right;">-by Harinee 🐰</div>', unsafe_allow_html=True)
    ...
    # elif website_menu == "Voice recorder":
        # st.write('hi')
        ...
        with st.expander("Research paper"):
            components.iframe("https://harinee-harinee-cse-03.on.drv.tw/harinee.html",
                              height=620, scrolling=True)
        with open("harinee.pdf", "rb") as file:
            btn = st.download_button(
                label="Download research paper",
                data=file,
                file_name="speech_emotion_detection-research_paper.pdf",
                mime="image/pdf"
            )
    ...
    #     with col1:
    #         st.info("sivashankarharinee711@gmail.com")
    #         # st.info("keerthanaelumala2002@gmail.com")
    #         # st.info("vibhamukund177@gmail.com")
    #     with col2:
    #         liimg = Image.open("images/insta.png")
    #         st.image(liimg)
    ...
    #         # emojis = ["🐶", "🐱", "🐭", "🐹", "🐰", "🦊", "🐻", "🐼"]
    #         st.markdown(f""":speech_balloon: [Harinee]()""",
    #                     unsafe_allow_html=True)
    #         # st.markdown(f""":speech_balloon: [Keerthana]()""",
    #         #             unsafe_allow_html=True)
    #         # st.markdown(f""":speech_balloon: [Vibha]()""",
    #         #             unsafe_allow_html=True)
    #         # st.button(f"Click Me {st.session_state.emoji}",
